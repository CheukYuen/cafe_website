...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_main">
        ...
        <div id="templatemo_content">
            ...
            <div class="image_wrapper2"><img src="padT.jpg" width="120" height="80" alt="padT"/></div>
            ...
            <div align="right" id="logindiv">
                ...
                <?php } else { ?>
                    ...
                    <div id="logoutdiv">
                        ...
                        <h2> Welcome to Pad Thai , <?php echo htmlentities($_SESSION["username"]); ?>.</h2>
        ...
        <form action="../../shopping_cart.php" method="post">
            <table width="100%" border="0" cellpadding="5px">
                <tr>
                    <td><span class="image_wrapper2"><img src="green.jpg" alt="green" width="150" height="100"/></span>
                    </td>
                    <td><span class="image_wrapper2"><img src="spicy.jpg" alt="spicy" width="150" height="100"/></span>
                    </td>
                    <td><span class="image_wrapper2"><img src="yellow.jpg" alt="yellow" width="150"
                                                          height="100"/></span>
                    </td>
                </tr>
                <tr>
                    <td valign="top" id="vFood"><strong>Green Curry </strong></td>
                    <td valign="top" id="rFood"><strong>Spicy Spaghetti</strong></td>
                    <td valign="top" id="gFood"><strong>Yellow Curry fried rice </strong></td>
                </tr>
                <tr>
                    <td>$11.95</td>
                    <td>$10.95</td>
                ...
                <tr>
                    <td><em>Coconut milk, eggplant, bell pepper and basil</em></td>
                    <td><em>Pan fried flat spaghetti or flat rice noodles with tomatoes, basil and Thai sauce</em></td>
                    <td><em>Fried rice, egg, tomatoes, onions, carrot & yellow curry</em></td>
                </tr>
                <tr>
                    <td><p>&nbsp;</p>
                ...
                <tr>
                    <td>Quantity:
                        <input type="text" size="5" maxlength="3" id="greenQTY" name="qty_green"
                               class="required input_field"/></td>
                    <td>Quantity:
                        <input type="text" size="5" maxlength="3" id="spicyQTY" name="qty_spicy"
                               class="required input_field"/></td>
                    <td>Quantity:
                        <input type="text" size="5" maxlength="3" id="yellowQTY" name="qty_yellow"
                               class="required input_field"/></td>
                </tr>
            </table>
            <div id="submit">
