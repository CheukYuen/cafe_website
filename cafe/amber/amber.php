...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_main">
        ...
        <div id="templatemo_content">
            ...
            <div class="image_wrapper2"><img src="amber.png" width="120" height="80" alt="amber"/></div>
        ...
        <form action="../../shopping_cart.php" method="post">
            <table width="100%" border="0" cellpadding="5px">
                <tr>
                    <td><span class="image_wrapper2"><img src="channa.jpg" alt="channa" width="150"
                                                          height="100"/></span></td>
                    <td><span class="image_wrapper2"><img src="mizauna.JPG" alt="mizauna" width="150"
                                                          height="100"/></span>
                    </td>
                    <td><span class="image_wrapper2"><img src="mushroom.jpg" alt="mushroom" width="150"
                                                          height="100"/></span></td>
                </tr>
                <tr>
                    <td valign="top" id="rFood"><strong>Channa Masala</strong></td>
                    <td valign="top" id="vFood"><strong>Mizauna &amp; Black Eyed </strong>

                        <p><strong>Pea Salad</strong></p></td>
                    <td valign="top" id="gFood"><strong>Varqui Mushroom</strong></td>
                </tr>
                <tr>
                    <td>$12.95</td>
                    <td>$7.50</td>
                ...
                <tr>
                    <td><em>Stewed garbanzo beans, home ground spices, tomatoes and ginger</em></td>
                    <td><em>With cucumber, jalapeno, tear drop tomatoes, cilantro lime vinaigrette</em></td>
                    <td><em>Layers of chettinad spiced mushrooms,crisp pastry</em></td>
                </tr>
                <tr>
                    <td><p>&nbsp;</p>
                ...
                <tr>
                    <td>Quantity:
                        <input type="number" size="5" maxlength="3" id="channaQTY" name="qty_channa"
                               class="required input_field"/></td>
                    <td>Quantity:
                        <input type="number" size="5" maxlength="3" id="mizaunaQTY" name="qty_mizauna"
                               class="required input_field"/></td>
                    <td>Quantity:
                        <input type="number" size="5" maxlength="3" id="mushroomQTY" name="qty_mushroom"
                               class="required input_field"/></td>
                </tr>
            </table>
            <div id="submit">
                ...
                <input type="submit" name="order" value="Order" id="btnorder" class="text_button2"/>
                </a>
            </div>
